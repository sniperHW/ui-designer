...
$source = 'C:\Users\Administrator\.codex\generated_images\01a06226-dd28-7bd2-bded-ab87ca129597\exec-132f644a-61ba-4152-bff2-9d4ed48f2b5f.png'
...
$bitmap.Save((Join-Path $output '卡牌页-视觉锚点图-巨像文明.png'), [System.Drawing.Imaging.ImageFormat]::Png)
