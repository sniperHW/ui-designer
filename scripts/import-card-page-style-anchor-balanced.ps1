...
$source = 'C:\Users\Administrator\.codex\generated_images\01a06226-dd28-7bd2-bded-ab87ca129597\exec-4654bc88-186f-4235-bf24-4bfda588735a.png'
...
$bitmap.Save((Join-Path $output '卡牌页-视觉锚点图-中和版.png'), [System.Drawing.Imaging.ImageFormat]::Png)
